  ...
  return (
    <>
      <footer className="bg-[#333333] shadow-md">
        <div className="container mx-auto px-20 py-10 flex justify-between items-center">
          ...
          <div className="w-1/3">
            ...
            <div className="flex my-2">
              <Image src={callLogo} className="mr-2" />
            ...
            <div className="flex my-2">
              <Image src={emailLogo} className="mr-2" />
        ...
        &#169; {date.getFullYear()} - All rights are reserved by <span className="text-[#4F7EC3]">Rotozest Industries</span> .
        </div>
      </footer>
    </>
  );
